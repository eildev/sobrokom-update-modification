                            ...
                            <div class="border p-4 rounded">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-sm-9 form-group">
                                        <input type="text" name="CategoryName" class="form-control  @error('CategoryName') is-invalid @enderror" id="inputEnterYourName" placeholder="Enter Blog Category Name" >
                                        @error('CategoryName')
